	...
	<br />
		...
		<div id="content">
			<legend><h3>Privacy Policy</h3></legend>
				<p>The Tasty Feets Incorporated respect the privacy of the visitors
					to the Tasty Feets.com website and the local websites connected with it, and take great care to protect your 
			...
			<hr>
				<h4>Protection of visitors information</h4>
					<p>In order to protect the information you provide to us by visiting our website we have implemented various
						...
						risk that third parties may intercept and use that information. While Tasty Feets strives to protect its user's 
...
<div>
	...
	<div id="footer">
	<div class="foot">
			<label style="font-size:17px;"> Copyrght &copy; 2021 </label>
			<p style="font-size:25px;">Tasty Feets </p>
		</div>
