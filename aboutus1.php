...
<div id="container">
		...
		<div id="content">
			...
			<br />
				<legend><h3>Vision</h3></legend>
					<h4 style="text-indent:60px;">Tasty Feets, the company that inspire, motivate, and give determination to the sports enthusiast.</h4>
			<br />
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Tasty Feets Inc. 2015</p>
		</div>
