			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<input type="password" name="password" required placeholder="Password" style="width:250px;">
					</center>
				</div>
				...
				$query = mysqli_query($conn, "SELECT *FROM product WHERE category='feature' ORDER BY product_id DESC") or die (mysqli_error());
					...
					while($fetch = mysqli_fetch_array($query))
						...
						if($qty <= 5){
							...
							<img class='img-polaroid' src='photo/".$fetch['product_image']."' height = '300px' width = '300px'></a>";
